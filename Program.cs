    ...
    class Program {
        static void Main(string[] args) {
            var central = new CentralDeExercicios(new Dictionary<string, Action>() {
                ...
                { "Paramametros Nomeados - Classes e Métodos", ParametrosNomeados.Executar},
                ...
                { "Parametros por referncia - Classes e Métodos", ParametrosPorReferencia.Executar},
                ...
                { "Igualdade - Colecões", ColecoesQueue.Executar},
                { "Stack - Colecões", Stack.Executar},
                { "Dictonary - Colecões", ColecoesDictonary.Executar},
